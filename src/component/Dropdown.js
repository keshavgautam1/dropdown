...
//   // return (
//   //   <div className="relative top-20 flex flex.col items-center w-[340px] h-[450px] rounded-lg">
...
//   //       {isOpen && (
//   //         <div className="bg-blue-400 mt-1 flex flex-col items-start rounded-lg p-2 w-full">
//   //           {list.map((item, i) => (
//   //             <div
//   //               key={i}
